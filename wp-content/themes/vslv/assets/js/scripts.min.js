    ...
    var module = _.extend({
        ...
        drawMediaOnCanvasAnimate: function(mediaElement, canvasElement) {
            ...
            function draw_next() {
                ...
                if (radius < sw) {
                    this.main_animation_loop = requestAnimationFrame(function() {
                        draw_next();
                    });
                } else {
