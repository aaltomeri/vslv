...
var PAGE_MODULE = function() {
    ...
    var collection, portfolioView, name = "project", Model = Backbone.Model.extend({
        initialize: function() {
        ...
        initialize: function() {},
        render: function() {
            return this.$el.html($("<img />").attr("src", this.model.get("thumbnail").url)), 
            this;
        },
        ...
        collection = new Collection(), portfolioView = new PortofolioView({
            el: "#portfolio",
