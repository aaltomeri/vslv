...
var DISCOVERY_MODULE = function() {
    var module = _.extend({
        ...
        setVideoDimensions: function(videoElement) {
            var master_dimension = this.c.width > this.c.height ? "width" : "height", other_dimension = master_dimension === "width" ? "height" : "width", md_value = this.c[master_dimension], od_value = "auto";
            if (device.ios()) {
                od_value = "100%";
