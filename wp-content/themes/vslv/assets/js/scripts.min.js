var VSLV_CONFIG = {
    ...
    discovery_hint_hide_duration: 1e3,
    modules: {
        page: {
            name: "page",
            route: "pages"
...
var DISCOVERY_MODULE = function() {
    var module = _.extend({
        ...
        setPosition: function() {
            var $parent = this.$el.parent(), pw = $parent.width(), ph = $parent.height(), w = this.$el.width(), h = this.$el.height(), x = Math.random() * pw + $parent.scrollLeft(), y = Math.random() * ph + $parent.scrollTop();
        ...
        common: {
            ...
            initMainMenu: function() {
                ...
                $(".navbar-collapse").on("show.bs.collapse", function() {
                    var logo_src = $(".navbar .navbar-brand img").attr("src"), new_logo_filename = "logo-vslv-color.svg", new_logo_src = logo_src.replace(/[^\/?]*\.[^\/?]*(\?.*)?$/, new_logo_filename);
                    $(".navbar").removeClass("collapsed");
                    $(".navbar .navbar-brand img").attr("src", new_logo_src);
                });
                $(".navbar-collapse").on("hide.bs.collapse", function() {
                    var logo_src = $(".navbar .navbar-brand img").attr("src"), new_logo_filename = "logo-vslv-white.svg", new_logo_src = logo_src.replace(/[^\/?]*\.[^\/?]*(\?.*)?$/, new_logo_filename);
