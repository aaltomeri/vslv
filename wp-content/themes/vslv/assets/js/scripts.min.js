...
}(), PROJECT_MODULE = function() {
    var name = "project", Model = Backbone.Model.extend({
        initialize: function() {
            console.log();
        }
    }), Collection = Backbone.Collection.extend({
...
}(), VSLV_APP = function(page_module, project_module) {
        ...
        common: {
            init: function() {
                $.get("/wp-json.php/").success(function(data) {
                    console.log(data);
                }), project_module.collection.fetch().success(function(data) {
                    console.log(data);
...
Backbone.history.start({
    ...
    href.attr.match(/media/) || href.prop && href.prop.slice(0, root.length) === root && (console.log(root), 
    console.log(href.attr), console.log(href.attr.replace(root, "")), evt.preventDefault(), 
